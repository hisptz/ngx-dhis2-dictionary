...
const allProgramIndicators = (state: AppState) => state.allIndicators.programIndicators;

export const getListOfIndicators = createSelector(indicatorsList, (indicatorsListObject: any) => indicatorsListObject);

export const getListOfProgramIndicators = createSelector(programIndicatorsList, (programIndicators: any) => programIndicators);
...
export const getAllProgramIndicators = createSelector(allProgramIndicators, (programIndicators: any) => programIndicators);
